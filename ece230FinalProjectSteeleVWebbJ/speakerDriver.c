...
void speakerBlare(void)
{
    ...
    while (1)
    {
        ...
        TIMER_A2->CCR[0] = notePeriods[noteIndex] - 1;
        TIMER_A2->CCR[3] = (notePeriods[noteIndex] / 2) - 1;
    }
}
