...
#define BAUDRATE    9600   //bits per seconds (Hz)
#define ClockPrescalerValue SYSTEMCLOCK/(16*BAUDRATE)   //312
...
//#define SecondModulationStage 15 //48MHz, 38400 Baud
...
//no parity
    EUSCI_A0->CTLW0 |= 0b0000000010000000;  //0x008x
//even parity, /bit 15 = 1 to enable parity; bit14=1 Even parity
